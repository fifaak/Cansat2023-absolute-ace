      ...
      <div class="container-fluid" style="justify-content: center">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            ...
            >
            <a class="nav-link active" aria-current="page" href="#" id="deployrocket"
              >🔴 Deploy Rocket</a
            >
            <a class="nav-link active" href="#"  id="deployparachute">🔴 Deploy Rocket Parachute</a>
            <a class="nav-link active" href="#"  id="deploycansatparachute">🔴 Deploy Cansat Parachute</a>
            <a
...
<div id="map" style="height: 500px;"></div>
        ...
        <div class="col-12 col-md-4">
          ...
          <div class="row">
            ...
            <div class="col">
              <button type="button" class="btn btn-primary" onclick="downloadlog(BMElog,'BME')">
                Download bme280 log
              </button>
            </div>
            <div class="col">
              <button type="button" class="btn btn-primary" onclick="downloadlog(GPSlog,'GPS')">
                Download gps log
              </button>
            </div>
          </div>
              ...
              <div> 
                ...
                <div style="display: flex;">
                  <input
                    ...
                    type="file"
                  />
                  <button type="button" class="btn btn-dark" id="upload_btn">Process</button>
                </div>
                <h1>Original</h1>
                <video width="100%" height="100%" controls id="video-tag">
                  <source id="video-source" src="" />
                </video>
                <div>
                  <h1>Segment Satellite</h1>
                </div>
                <video width="100%" height="100%" controls id="output_video_tag">
                  <source id="video-source" src="" />
                </video>
